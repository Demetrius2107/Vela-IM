...
/**
 * <p>Title: GroupApplicationContextLoadTest</p>
 * <p>Description: Spring 上下文加载护栏测试，验证 GroupApplication 的 Bean 组装无误。
 ...
 */
@SpringBootTest(
        classes = GroupApplication.class,
        properties = {
                "spring.datasource.hikari.initialization-fail-timeout=-1",
                "spring.rabbitmq.listener.simple.auto-startup=false"
        })
class GroupApplicationContextLoadTest {
